...
public abstract class Block extends Thread{
    ...
    public static void drawPreview(Graphics2D g,ImageObserver io, Block block){
        
        //if(block instanceof Iblock){
            g.drawRoundRect(30,30,mainSize*2 , mainSize*2, arcSize, arcSize);
        //}else if(block instanceof Sblock){
            g.drawOval(30,30,mainSize*2 , mainSize*2);
        //}
